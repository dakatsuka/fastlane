...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency('google-cloud-env', '>= 2.2.0', '< 3.0.0') # Must be < 2.0.0 to support Ruby 2.6
  spec.add_dependency('google-cloud-storage', '~> 1.31') # Access Google Cloud Storage for match
  spec.add_dependency('googleauth', '>= 1.16', '< 2.0.0') # Because it supports impersonated service account
